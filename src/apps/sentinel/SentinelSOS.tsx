...
import { AlertTriangle, ShieldOff, Phone, Users, X, EyeOff } from "lucide-react";
  ...
  return (
    <>
      <StealthMode
        ...
        onSOSTriggered={handleStealthSOS}
        onExit={() => setStealthEnabled(false)}
      />
          ...
          <Card className="bg-muted/30">
            ...
            <CardContent>
              <p className="text-xs text-muted-foreground leading-relaxed">
                Le mode discret transforme Sentinel en calculatrice. Tapez <strong>911</strong> puis <strong>=</strong> pour 
                déclencher un SOS invisible. Sur mobile, secouez le téléphone 3 fois. 
                L'historique visible est masqué mais les alertes serveur sont maintenues.
              </p>
            </CardContent>
          </Card>
